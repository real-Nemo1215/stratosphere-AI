...
export default function ConnectAccountPage() {
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-primary">Connect Cloud Account</h1>
        <p className="text-muted-foreground">Mock integration. No real AWS credentials are used.</p>
      </div>
